...
class AutomatorWP_PeepSo_Change_Avatar extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'select_option'     => __( 'User changes his <strong>profile avatar</strong>', 'automatorwp-peepso-integration' ),
            /* translators: %1$s: Number of times. */
            'edit_label'        => sprintf( __( 'User changes his profile avatar %1$s time(s)', 'automatorwp-peepso-integration' ), '{times}' ),
            'log_label'         => __( 'User changes his profile avatar', 'automatorwp-peepso-integration' ),
