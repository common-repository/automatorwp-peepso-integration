...
class AutomatorWP_PeepSo_Create_Group extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User creates a group', 'automatorwp-peepso-integration' ),
            'select_option'     => __( 'User <strong>creates</strong> a group', 'automatorwp-peepso-integration' ),
            /* translators: %1$s: Number of times. */
            'edit_label'        => sprintf( __( 'User creates a group %1$s time(s)', 'automatorwp-peepso-integration' ), '{times}' ),
            'log_label'         => __( 'User creates a group', 'automatorwp-peepso-integration' ),
