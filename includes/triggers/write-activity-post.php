...
class AutomatorWP_PeepSo_Write_Activity_Post extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User writes an activity post', 'automatorwp-peepso-integration' ),
            'select_option'     => __( 'User <strong>writes</strong> an activity post', 'automatorwp-peepso-integration' ),
            /* translators: %1$s: Number of times. */
            'edit_label'        => sprintf( __( 'User writes an activity post %1$s time(s)', 'automatorwp-peepso-integration' ), '{times}' ),
            'log_label'         => __( 'User writes an activity post', 'automatorwp-peepso-integration' ),
