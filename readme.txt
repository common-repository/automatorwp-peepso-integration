...
Tags: peepso, automatorwp, store, ecommerce, product
...
Connect AutomatorWP with PeepSo
...
[PeepSo](https://wordpress.org/plugins/peepso-core/ "PeepSo") helps you build any kind of community website using WordPress, with member profiles, activity streams, user groups, messaging, and more.

This plugin automatically connects [AutomatorWP](https://wordpress.org/plugins/automatorwp/ "AutomatorWP") with PeepSo adding new triggers that you can use to connect with other plugins and automate workflows letting you save time and get focused on your most important work.

= Triggers =

* User changes his profile avatar.
* User writes an activity post.
* User creates a group.

= Pro version =

[Pro version](https://automatorwp.com/add-ons/peepso/ "AutomatorWP - PeepSo") available that let's you expand the integration between AutomatorWP and PeepSo bringing you more ways to automatize your community.
